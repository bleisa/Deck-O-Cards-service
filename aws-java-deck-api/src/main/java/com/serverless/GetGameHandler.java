...
import com.serverless.dal.WayToPlay;
...
public class GetGameHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {

	private static final Logger LOG = LogManager.getLogger(GetGameHandler.class);
